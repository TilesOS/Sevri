  ...
  return (
    <button
      ...
      className={cn(
        ...
        checked ? "border-line-strong bg-paper shadow-soft" : "border-line bg-surface/35 hover:border-line-strong hover:bg-paper",
      )}
    >
      <div className="flex items-start justify-between gap-4">
        ...
        <span
          className={cn(
            ...
            checked ? "border-ink bg-accent" : "border-line-strong bg-paper",
          )}
          aria-hidden="true"
        />
      </div>
